      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
          <div className="flex flex-col">
            ...
            />
            {errors.firstName && (
              <span className="text-red-500 mt-1">{errors.firstName}</span>
            )}
          </div>
          <div className="flex flex-col">
            ...
            />
            {errors.lastName && (
              <span className="text-red-500 mt-1">{errors.lastName}</span>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          <button
            className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transform py-4 bg-orange-400 rounded-xl text-white font-bold text-lg"
